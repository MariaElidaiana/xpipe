...
g2  = -f['catalog/metacal/unsheared/e_2'][...][select_idx]           #Do I really need multiplied by -1? 
...
g2sens        = R22
g12sens       = (R12+R21)/2.
source_weight = np.ones(len(ids))                                             #placeholder
...
print("Saving ...")
#np.savetxt('/global/cscratch1/sd/mariaeli/Y3_DATA/Y3_mastercat_5_24_19_subsampled_metacal_no-e2.dat',
